...
set(ENV{QNX_HOST} /opt/qnx700/host/linux/x86_64)
set(ENV{QNX_TARGET} /opt/qnx700/target/qnx7)
...
set(TOOLCHAIN "/opt/qnx700/host/linux/x86_64")

set(CMAKE_CXX_COMPILER "${TOOLCHAIN}/usr/bin/aarch64-unknown-nto-qnx7.0.0-g++")
set(CMAKE_C_COMPILER "${TOOLCHAIN}/usr/bin/aarch64-unknown-nto-qnx7.0.0-gcc")
set(GCC_COMPILER_VERSION "4.9" CACHE STRING "GCC Compiler version")

# setup compiler for cross-compilation
set(CMAKE_CXX_FLAGS           "-fPIC -D_QNX_SOURCE"               CACHE STRING "c++ flags")
set(CMAKE_C_FLAGS             "-fPIC -D_QNX_SOURCE"               CACHE STRING "c flags")
...
set(LD_PATH_EXTRA ${VIBRANTE_PDK}/targetfs/lib)

set(ENV{PKG_CONFIG_LIBDIR} ${LD_PATH}/dds/pkgconfig)
...
include_directories("/home/gl/qnx700/target/qnx7/usr/include/aarch64")
